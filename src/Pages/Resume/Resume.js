...
const Resume = () => {
  ...
  return (
    <div className='resume'  style={{width:"100%",height:"100vh"}}>

<h1 className=' py-2' style={{
            borderBottom:"3px solid white",width:"15rem",margin:"auto",color:"#0fe",marginBottom:"3rem"
        }}>My-Resume</h1>
   <div style={{margin:"4rem",width:"87%",height:"auto" ,backgroundColor:"#212428", boxShadow:"10px 10px 19px #1c1e22, -10px -10px 19px #262a2e"}}>
    <ul className='d-flex mt-5 ' style={{justifyContent:"space-around"}}>
        <li className=' p-3 ' style={{fontSize:"2rem"}}><button 
          onClick={()=>
          setEducation(true)& 
          setSkills(false)&
          setProjects(false)} 
        ...
        <li className=' p-4 'style={{fontSize:"2rem"}}><button 
     onClick={()=>
         setEducation(false)& 
         setSkills(true)&
         setProjects(false)} 
